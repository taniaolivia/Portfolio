    ...
    data: {
        projects: [
            ...
            },
            {
                ...
                project: "timer",
                name: "Timeroo",
                description: "Timeroo is a school project where my three partners and I are building a web application from the ground up. Our team consists of four developers. The objective of this web application is to provide users with a comprehensive tool to manage and track the time spent on various projects. Users can assign one or more groups to each project, where each group can contain multiple invited or added users.<br><br>To achieve this, I'm leveraging a range of technical skills. On the back end, I'm creating APIs using Node.js, MongoDB, Mongoose, Express.js, and Docker. I'm adept at managing data storage with MongoDB, ensuring efficient and scalable database management. Security is a top priority, so I'm implementing JWT for secure API interactions.<br><br>For the front end, I'm developing user interfaces and the web application itself using React.js, HTML, and Tailwind CSS, ensuring a smooth and responsive experience for users.",
                status: "Finished",
                year: "2023",
                ...
                ressources: [
                    {
                        page: "Demonstration of Timeroo",
                        description: "This is the demonstration of the timeroo web application.",
            ...
            },
            {
                ...
                project: "space-x",
                name: "Space-X",
                description: "Space-X is a simple school project that I've worked on twice, each time with a different approach. The project allows users to see a comprehensive list of capsules and launches, as well as view detailed information about each launch and capsule.<br><br>The first version of this project was a collaborative effort with my two partners. Together, we created the project using React.js, Tailwind CSS, HTML, and CSS. This version focused on providing a user-friendly interface and efficient data presentation to ensure a seamless experience for users exploring Space-X information.<br><br>The second version of the project was developed by me alone. In this iteration, I used Vue.js along with Tailwind CSS, HTML, and CSS. This solo effort allowed me to explore a different framework and implement the same functionalities, ensuring that users can easily access and navigate through the list of capsules and launches, as well as view detailed information for each.",
                status: "Finished",
                year: "2023",
                genre: "Web Application",
            ...
            },
            {
                ...
                project: "reuninou",
                name: "Reuninou",
                description: "Reuninou is a workshop project that I collaborated on with my three friends. We developed a web and mobile application that allows groups of people to set a meeting at a specific location and organize this meeting. The mobile version is reserved for registered users on the platform, while the web version offers certain functionalities that are also accessible to non-registered users.<br><br>To achieve this, I leveraged a range of technical skills. The back office and web application were developed using Vue.js. The mobile application was created using Flutter to ensure a smooth and responsive experience for users. The API was developed using Node.js, providing robust backend support. We used phpMyAdmin for managing and storing the database.",
                status: "Finished",
                year: "2022",
                genre: "Mobile and web Application",
                languages: "Node.js, MySQL, Express.js, Docker, Flutter, Google API",
                links: [
                    "https://github.com/Tenebrosful/Reunionou-MobileApp",
                    "https://github.com/Tenebrosful/Reunionou-BackOffice",
                    "https://github.com/Tenebrosful/Reunionou-WebApp",
                ],
                ressources: [
                    {
        ...
        rd: [
            {
                ...
                project: "blob",
                name: "AI Blob 3D",
                description: "AI Blob 3D is a project I completed for the client Essilor during my apprenticeship. This project features a 3D model that moves in a random wave-like motion, providing a dynamic and visually engaging experience.<br><br>To create this, I used a range of technologies including Vue.js for the application framework, Three.js for the 3D graphics, and HTML, CSS, and SASS/SCSS for styling. The combination of these technologies allowed me to develop a smooth, interactive 3D blob that showcases advanced animation and rendering techniques.<br><br>Overall, this rd demonstrates my ability to integrate complex 3D animations into a web application, providing a unique and captivating user experience.",
                status: "Finished",
                year: "2023",
            ...
            },
            {
                ...
                project: "tree",
                name: "Tree 3D",
                description: "Tree 3D is a research and development project where I created a 3D model of a tree from scratch using Three.js, without relying on Blender. This project involved developing the 3D geometry entirely through code, showcasing my ability to manipulate 3D graphics programmatically.<br><br>To achieve this, I utilized a range of technologies including Vue.js for the application framework, Three.js for the 3D graphics, and HTML, CSS, and SASS/SCSS for styling. The project demonstrates advanced techniques in 3D modeling and rendering, providing a realistic and interactive representation of a tree.<br><br>Overall, Tree 3D highlights my proficiency in creating complex 3D models using code and integrating them into a web application with Vue.js to deliver a seamless and engaging user experience.",
                status: "Finished",
                year: "2023",
                genre: "Web Application - 3D Model",
                languages: "Vue.js, Three.js, HTML, CSS, SASS/SCSS",
            ...
            },
            {
                ...
                project: "word search",
                name: "Word Search",
                description: "Word Search is a web application game that I developed during my apprenticeship for the client Essilor. This game can be played on both mobile and PC, providing a versatile and engaging experience for users. The objective of the game is to find all the specified words hidden within a grid.<br><br>To create this game, I used a range of technologies including Vue.js for the application framework, Phaser.js for the game engine, and HTML, CSS, and SASS/SCSS for styling. This project is a mockup game developed and tested as part of an R&D initiative to be used in Essilor's project.<br><br>Overall, Word Search demonstrates my ability to develop interactive and enjoyable web-based games, ensuring compatibility across multiple platforms and delivering a seamless user experience.",
                status: "Finished",
                year: "2023",
                genre: "Web Application - Game",
            ...
            },
            {
                ...
                description: "Rock Paper Scissors is a web application game that I developed during my free time in my apprenticeship. This project was an initiative of my own, where I aimed to create a more visually engaging and dynamic version of the classic rock-paper-scissors game. Instead of just a simple game, I designed it to resemble a fight game where the player and the enemy lose a life if they lose a round.<br><br>To build this game, I utilized Vue.js for the application framework, Phaser.js for the game engine, and HTML, CSS, and SASS/SCSS for styling. This R&D project allowed me to explore and experiment with game development concepts, creating a more interactive and immersive gaming experience.<br><br>Overall, Rock Paper Scissors highlights my creativity and technical skills in developing web-based games, transforming a simple concept into an exciting and visually appealing game.",
                status: "Finished",
                year: "2024",
                genre: "Web Application - Game",
                languages: "Vue.js, Phaser.js, HTML, CSS, SASS/SCSS",
            ...
            },
            {
                ...
                description: "Don't Eat the Salad is a web application game that I developed as a practice project while learning Phaser.js. The game, inspired by shooting games but without the shooting, challenges players to eat all the junk foods to gain points and avoid the salad, which results in losing points.<br><br>To build this game, I used Vue.js for the application framework, Phaser.js for the game engine, and HTML, CSS, and SASS/SCSS for styling. This project is designed to be adaptable for both mobile and desktop, ensuring a seamless gaming experience across devices.<br><br>Overall, Don't Eat the Salad showcases my ability to learn new technologies quickly and develop an engaging, cross-platform web-based game.",
                status: "Finished",
                year: "2023",
                genre: "Web Application - Game",
                languages: "Vue.js, Phaser.js, HTML, CSS, SASS/SCSS",
            ...
            },
            {
                ...
                project: "dog",
                name: "Shiba inu",
                description: "Shiba Inu is a 3D model of a dog that I created as my first attempt at learning Three.js. I built the dog model entirely from scratch using geometries in Three.js, without relying on Blender.<br><br>To achieve this, I used a range of technologies including Vue.js for the application framework, Three.js for the 3D graphics, and HTML, CSS, and SASS/SCSS for styling. This project demonstrates my ability to create complex 3D models programmatically and integrate them into a web application.<br><br>Overall, Shiba Inu highlights my skills in 3D modeling and rendering with Three.js, showcasing my capability to learn and apply new technologies to create interactive and visually engaging web content.",
                status: "Finished",
                year: "2023",
                genre: "Web Application - 3D Model",
                languages: "Vue.js, Three.js, HTML, CSS, SASS/SCSS",
            ...
            },
            {
                ...
                project: "zombie",
                name: "Zombie Attack",
                description: "Zombie Attack is a web application 3D game that I developed using Three.js and Vue.js as the main technologies. This R&D project was created to deepen my knowledge and improve my skills with Three.js.<br><br>In Zombie Attack, the player needs to attack zombies to gain points. Additionally, the player can collect coins to earn extra points. The game provides an interactive and engaging experience, leveraging the capabilities of Three.js for 3D graphics and Vue.js for the application framework.<br><br>To build this game, I used HTML, CSS, and SASS/SCSS for styling, ensuring a visually appealing and responsive design.<br><br>Overall, Zombie Attack showcases my ability to develop 3D web-based games, enhancing my expertise in Three.js and Vue.js while delivering a fun and dynamic gaming experience.",
                status: "Finished",
                year: "2023",
                genre: "Web Application - Game",
                languages: "Vue.js, Three.js, HTML, CSS, SASS/SCSS",
